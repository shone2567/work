...
. /root/compute_service_for_compute/compute_service_compute_node_deploy.sh
...
#storage
scp -r block_storage_mitaka/cinder_storage/ root@block1:/root
ssh root@block1
. /root/block_storage_mitaka/cinder_storage/block_storage_service_deploy.sh
